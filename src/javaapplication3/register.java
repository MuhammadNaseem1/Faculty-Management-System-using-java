...
public class register extends javax.swing.JFrame {
   ...
   try{
      ...
      String address=j5.getText();
       System.out.println("Inserting records into the table...");
      stmt.executeUpdate("INSERT INTO Student VALUES ('"+name+"','"+id+"', '"+address+"', '"+dept+"','"+phone+"')");
        // stmt.executeUpdate("INSERT INTO hostel VALUES ('"+hostelNo+"','"+id+"', '"+address+"', '"+dept+"','"+phone+"')");
      JOptionPane.showMessageDialog(null,"<html><h1 style='font-family: Calibri; font-size: 30pt;'>Student Added!");
